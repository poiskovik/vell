...
//$delete=Adelete('anton'); //Удаление пользователя (имя)

//$auth=Aauth('Oleg','5fsefq11wert'); //Авторизация пользователя (имя,пароль)

$get=Aget('kolya'); //Получить информацию о пользователе (имя)
